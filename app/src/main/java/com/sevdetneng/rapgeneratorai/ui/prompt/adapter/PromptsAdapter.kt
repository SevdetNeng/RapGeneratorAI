package com.sevdetneng.rapgeneratorai.ui.prompt.adapter
...
import com.sevdetneng.rapgeneratorai.databinding.PromptsRecyclerItemBinding
import com.sevdetneng.rapgeneratorai.model.data.Prompt

class PromptsAdapter(val onClick: (prompt: Prompt) -> Unit) : ListAdapter<Prompt,PromptsAdapter.ViewHolder>(PromptsDiffCallback()) {
